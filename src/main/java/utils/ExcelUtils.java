...
public class ExcelUtils {
	...
	private static String sheetPath = ConfigurationReader.getProperty("test.data.path")+ConfigurationReader.getProperty("excel.name");
	private static String sheetName = ConfigurationReader.getProperty("sheet.name");
